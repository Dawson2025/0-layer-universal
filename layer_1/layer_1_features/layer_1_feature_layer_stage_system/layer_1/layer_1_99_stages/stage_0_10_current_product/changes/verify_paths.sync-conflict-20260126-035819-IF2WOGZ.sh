#!/bin/bash
# resource_id: "d6ff6a09-6f16-4117-91d1-d28ed57d0fb7"
# resource_type: "script"
# resource_name: "verify_paths.sync-conflict-20260126-035819-IF2WOGZ"
...
CRITICAL_DIRS=(
  ...
  "$CONTEXT_ROOT/layer_0/layer_0_99_stages/stage_0.08_current_product"
  "$CONTEXT_ROOT/layer_0/layer_0_99_stages/stage_0.09_archives"
)
