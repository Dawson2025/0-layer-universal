...
<!-- section_id: "160963d4-37ab-40a1-a064-09e17dc29f50" -->
## Naming Convention
...
<!-- section_id: "1e8a7b5e-d487-400a-abec-1666afa8d50a" -->
## When to Create a Feature

Create a feature when you have:
- A distinct topic or functional area within the project
...
<!-- section_id: "1f2614f4-653e-4162-91fd-f7f2579a1807" -->
## Note on "Sub" Prefix
...
Since this is a feature inside a project (different types), it does NOT use the "sub" prefix.
