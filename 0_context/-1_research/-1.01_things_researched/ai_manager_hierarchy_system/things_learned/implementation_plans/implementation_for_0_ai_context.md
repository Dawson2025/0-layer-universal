...
- For each of `layer_0_universal`, `layer_1_project`, `layer_2_features`, and `layer_3_components`:
...
- In a central, discoverable location (e.g. `layer_0_universal/0.01_manager_handoff_documents/0.00_to_universal/handoff_schema.md`):
...
- In `layer_0_universal/0.02_sub_layers/sub_layer_0.12_universal_tools` and `sub_layer_0.10_mcp_servers_and_tools_setup`:
