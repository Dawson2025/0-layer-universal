...
- sub_layer_2.05_feature_os: platform/browser/runtime specifics (if any).
- sub_layer_2.06_feature_env_layout: where the feature lives, services/modules it touches, env/config needs.
- sub_layer_2.07_feature_architecture: FE/BE/data/API shape for this feature.
- sub_layer_2.08_feature_coding_app_setup: run/debug configs, scripts for this feature.
- sub_layer_2.09_feature_apps_tools: dashboards/monitoring/admin relevant to this feature.
- sub_layer_2.10_feature_ai_app_tool_usage: feature-level AI workflows.
- sub_layer_2.11_feature_model_usage: models wired into this feature (if any).
