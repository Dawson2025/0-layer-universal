# Alias: `environment_setup`

**Purpose**: Stable link to this sub-layer (numeric ordering may change).

- Current folder: `sub_layer_0.06_environment_setup`
- Open: [sub_layer_0.06_environment_setup](../../sub_layer_0.06_environment_setup/README.md)
