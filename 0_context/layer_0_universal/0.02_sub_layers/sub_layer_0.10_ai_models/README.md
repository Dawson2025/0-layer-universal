...
- **Depends on**: 
  - `sub_layer_0.08_ai_apps_tools_setup` - Models are used through AI apps/tools
  - `sub_layer_0.09_mcp_servers_and_tools_setup` - Some models may be accessed via MCP
