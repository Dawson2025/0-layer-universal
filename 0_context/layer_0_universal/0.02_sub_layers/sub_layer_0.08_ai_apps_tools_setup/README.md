# Sub Layer 0.08: AI Apps & Tools Setup
...
- Universal Layer: `layer_0_universal/0.02_sub_layers/sub_layer_0.08_ai_apps_tools_setup/`
...
- **Sub Layer 0.06:** Coding App Setup
  - Path: `layer_0_universal/0.02_sub_layers/sub_layer_0.06_coding_app_setup/`
  - IDE and editor setup
- **Sub Layer 0.09:** MCP Servers and Tools Setup
  - Path: `layer_0_universal/0.02_sub_layers/sub_layer_0.09_mcp_servers_and_tools_setup/`
  - For Model Context Protocol servers and tools
  - **Note**: MCP setup requires AI apps/tools to be installed first (this sub-layer)
- **Sub Layer 0.10:** AI Models
  - Path: `layer_0_universal/0.02_sub_layers/sub_layer_0.10_ai_models/`
...
**Important Note**: Claude Code uses CLI-based MCP configuration (not config files). See MCP setup in `sub_layer_0.09_mcp_servers_and_tools_setup` for details.
...
- [ ] MCP servers configured (see `sub_layer_0.09_mcp_servers_and_tools_setup`)
...
- From universal context root: `layer_0_universal/0.02_sub_layers/sub_layer_0.08_ai_apps_tools_setup/`
- From project context: `../../0_ai_context/0_context/layer_0_universal/0.02_sub_layers/sub_layer_0.08_ai_apps_tools_setup/`
