...
This document describes how to update Claude Code CLI to the latest version on Linux Ubuntu. For cross-platform documentation, see the [shared update guide](../../../../../../_shared/0.03_environments/_shared/0.04_coding_apps/_shared/0.05_ai_apps/claude_code_cli/setup/UPDATE.md).
...
- **Shared Update Guide:** `../../../../../../_shared/0.03_environments/_shared/0.04_coding_apps/_shared/0.05_ai_apps/claude_code_cli/setup/UPDATE.md`
...
- **Universal Tools Config:** `../../../../../../_shared/0.03_environments/_shared/0.04_coding_apps/_shared/0.05_ai_apps/_shared/0.07_universal_tools/trickle_down_0.75_universal_tools/0_instruction_docs/claude-code-config/`
