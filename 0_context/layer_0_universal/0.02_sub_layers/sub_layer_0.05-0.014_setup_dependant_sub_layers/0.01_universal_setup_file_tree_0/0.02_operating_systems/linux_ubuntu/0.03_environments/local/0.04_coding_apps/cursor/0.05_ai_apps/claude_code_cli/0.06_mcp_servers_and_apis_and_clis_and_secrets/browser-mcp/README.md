...
cd /path/to/0.06_mcp_servers_and_apis_and_secrets/browser-mcp/setup/scripts
...
- [Basic Navigation Workflow](./0.08_protocols/basic_navigation_workflow.md)
- [Multi-Tab Workflow](./0.08_protocols/multi_tab_workflow.md)
- [Data Extraction Workflow](./0.08_protocols/data_extraction_workflow.md)
