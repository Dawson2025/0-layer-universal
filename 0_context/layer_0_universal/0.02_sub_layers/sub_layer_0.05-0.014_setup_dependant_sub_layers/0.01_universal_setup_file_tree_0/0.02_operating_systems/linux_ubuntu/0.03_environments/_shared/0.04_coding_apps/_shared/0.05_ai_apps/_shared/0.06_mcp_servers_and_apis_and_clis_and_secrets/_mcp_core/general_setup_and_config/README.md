...
- **0.06_mcp_servers_and_apis_and_secrets/browser-mcp/general_setup_and_config/**
- **0.06_mcp_servers_and_apis_and_secrets/playwright-mcp/general_setup_and_config/**
- **0.06_mcp_servers_and_apis_and_secrets/chrome-devtools-mcp/general_setup_and_config/**
- **sub_layer_0.10_mcp_servers_and_tools_setup/** for comprehensive MCP documentation

For AI app-specific issues, see:
- **0.05_ai_apps/claude_code_cli/** for Claude Code CLI
- **0.05_ai_apps/cursor_agent/** for Cursor Agent
- **sub_layer_0.09_ai_apps_tools_setup/** for detailed AI app documentation

For OS-specific issues, see:
- **0.02_operating_systems/linux_ubuntu/** for Linux-specific MCP issues
- **0.02_operating_systems/macos/** for macOS-specific MCP issues
- **0.02_operating_systems/windows/** for Windows-specific MCP issues
- **0.02_operating_systems/wsl/** for WSL-specific MCP issues
