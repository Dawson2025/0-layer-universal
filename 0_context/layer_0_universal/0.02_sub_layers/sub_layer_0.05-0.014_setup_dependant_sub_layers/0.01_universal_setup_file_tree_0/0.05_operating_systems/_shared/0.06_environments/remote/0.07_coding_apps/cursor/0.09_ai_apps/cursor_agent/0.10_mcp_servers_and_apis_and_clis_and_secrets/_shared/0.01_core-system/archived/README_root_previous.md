# archived: sub_layer_0.10_mcp_servers_and_tools_setup (previous README)
...
- **Depends on**: `sub_layer_0.09_ai_apps_tools_setup` - MCP setup requires the AI app/tool to be installed first
