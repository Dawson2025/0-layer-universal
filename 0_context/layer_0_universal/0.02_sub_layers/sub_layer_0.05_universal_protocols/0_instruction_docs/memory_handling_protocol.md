...
2.  **Confirm with Exactness:** In your response to the user, you MUST explicitly provide the following in this specific order:
    ...
    *   **Exact Directory Location:** Provide the **full, absolute, or root-relative path** to the file(s) you modified. Do not just say "in the project folder." Show the path starting from `0_ai_context` or the project root.
...
> **Exact Location:** `code/1_school/lang-trak-in-progress/0_context/layer_2_features/layer_2_feature_.../sub_layer_2.11_feature_tools/README.md`
