...
6. **Navigate to AI model**: `0.06_ai_models/<ai_model>/general_setup_and_config/`
   ...
   - Claude Opus: `0.06_ai_models/claude-opus/`
   - GPT-4: `0.06_ai_models/gpt-4/`

7. **Navigate to universal tools**: `0.07_universal_tools/<tool>/general_setup_and_config/`
   - Git: `0.07_universal_tools/git/`
   - Docker: `0.07_universal_tools/docker/`
   - NPM: `0.07_universal_tools/npm/`

8. **Navigate to protocols**: `0.08_protocols/<protocol>/general_setup_and_config/`
   - Terminal Protocol: `0.08_protocols/terminal_protocol/`
   - Browser Protocol: `0.08_protocols/browser_protocol/`
   - Git Protocol: `0.08_protocols/git_protocol/`

9. **Navigate to agent setup**: `0.09_agent_setup/general_setup_and_config/`
   - Manager agents
   - Stage agents
   - Testing agents
...
- `0.07_universal_tools/<tool>/general_setup_and_config/` - Tool installation, usage, issues

### Where to place protocol setup docs:
- `0.08_protocols/<protocol>/general_setup_and_config/` - Protocol rules, conventions, best practices

### Where to place agent setup docs:
- `0.09_agent_setup/general_setup_and_config/` - Agent configuration, registration, deployment
...
## Legacy sub_layer_0.06_coding_app_setup Source
...
## Legacy sub_layer_0.07_environment_setup Source
...
## Legacy sub_layer_0.08_apps_browsers_extensions_setup Source
...
## Notes
- Keep OS-specific details in `sub_layer_0.05_os_setup/`.
- Keep AI app install/config in `sub_layer_0.09_ai_apps_tools_setup/`.
- Keep MCP-specific setup in `sub_layer_0.10_mcp_servers_and_tools_setup/`.

Add slot-specific docs here over time.

---

## Legacy sub_layer_0.09_ai_apps_tools_setup Source
...
- Main README: `../../sub_layer_0.12_universal_tools/trickle_down_0.75_universal_tools/0_instruction_docs/claude-code-config/README.md`
- Quick Start: `../../sub_layer_0.12_universal_tools/trickle_down_0.75_universal_tools/0_instruction_docs/claude-code-config/QUICK_START.md`
- What Actually Works: `../../sub_layer_0.12_universal_tools/trickle_down_0.75_universal_tools/0_instruction_docs/claude-code-config/WHAT_ACTUALLY_WORKS.md`

**Important Note**: Claude Code uses CLI-based MCP configuration (not config files). See MCP setup in `sub_layer_0.10_mcp_servers_and_tools_setup` for details.
...
- [ ] MCP servers configured (see `sub_layer_0.10_mcp_servers_and_tools_setup`)
...
## Legacy sub_layer_0.11_ai_models Source
...
## Legacy sub_layer_0.12_universal_tools Source
...
- MCP-related tools have been moved to `sub_layer_0.10_mcp_servers_and_tools_setup`
- Universal tools are used by agents configured in `sub_layer_0.13_agent_setup`
- Add slot-specific docs here over time
- Keep mappings up to date if paths change
...
## Legacy sub_layer_0.13_universal_protocols Source
...
## Legacy sub_layer_0.14_agent_setup Source
