...
This document describes how to update Gemini CLI to the latest version on Linux Ubuntu. For cross-platform documentation, see the [shared update guide](../../../../../../_shared/0.03_environments/_shared/0.04_coding_apps/_shared/0.05_ai_apps/gemini_cli/setup/UPDATE.md).
