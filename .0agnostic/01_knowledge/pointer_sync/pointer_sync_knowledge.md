...
| `entity-find.sh` | `.0agnostic/entity-find.sh` | Fast entity lookup by name (~5ms, no Python) |
| `.entity-lookup.tsv` | Repo root | Flat entity index (name/uuid/path), generated by --rebuild-index |
