...
- [ ] If I created an entity, does it have the canonical structure from `.0agnostic/06_context_avenue_web/01_file_based/04_@import_references/entity_structure.md`?
