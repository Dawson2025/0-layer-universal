...
|-----------|-------------|-----|
| gsd daemon failures, DISPLAY race condition, brightness keys broken after reboot, Ctrl+Alt+S not working after boot | `gsd_session_startup/` | Dedicated entity for fixing systemd user env DISPLAY import timing |
...
|------|-------------|--------|-------------|
| N1: Desktop Services | gsd-media-keys and gsd-power must run reliably | Active — gsd_session_startup entity | `gsd_session_startup/stages/stage_01_request_gathering/outputs/requirements_tree.md` |
...
| N4: Display Server Availability | DISPLAY env var in systemd user env before services | Active — gsd_session_startup entity | `gsd_session_startup/stages/stage_02_research/outputs/display_race_condition.md` |
