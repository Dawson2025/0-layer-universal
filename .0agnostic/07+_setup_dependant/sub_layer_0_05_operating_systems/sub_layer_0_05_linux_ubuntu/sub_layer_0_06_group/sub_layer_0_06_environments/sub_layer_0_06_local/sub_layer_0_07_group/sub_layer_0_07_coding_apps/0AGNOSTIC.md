---
resource_id: "70deb470-da80-45c9-b136-a90ee1d5a5f1"
...
| Path | Purpose |
|------|---------|
| `sub_layer_0_07_group/sub_layer_0_07_99_stages/` | Internal stages (12 stages) |
| `sub_layer_0_08_group/sub_layer_0_08_cursor/` | Child: Cursor IDE entity |
| `.0agnostic/01_knowledge/legacy_shared/` | Legacy shared content (pre-restructuring, old naming) |
| `.0agnostic/01_knowledge/` | Coding apps knowledge |
| `.0agnostic/03_protocols/` | Coding apps protocols |
