---
resource_id: "1a16fd98-ad76-43f0-a43c-58cdfb4c3ee9"
...
<!-- section_id: "20ac6024-356b-40f1-a05f-8857ea8fa087" -->
## Overview
...
<!-- section_id: "272d29e7-6466-491a-8921-facaa8654245" -->
## Tool Categories

<!-- section_id: "3c777a84-15f4-45e6-ab72-41bc3ebb96ac" -->
...
<!-- section_id: "4b3c9246-8373-407f-9ecf-3f6196c7c7da" -->
...
<!-- section_id: "a0f15dff-66ed-4d2e-b4f8-ffd98e7e89e6" -->
...
<!-- section_id: "82fbf947-7f6a-460e-9849-0c65c108c04b" -->
...
<!-- section_id: "39501ca8-05e5-4ea1-a7b4-375ce75995ac" -->
...
<!-- section_id: "f5820d5b-a45b-45a0-aca6-7ce2ba520c12" -->
...
#### 6.1 Spec-Driven Development (Spec Kit)
- **GitHub Spec Kit**: Structured 4-phase validation process
- **Version-Controlled Specifications**: Specifications alongside code
- **AI Integration**: Works with Copilot, Claude Code, Gemini CLI
- **Quality Assurance**: Validation checkpoints at each phase

#### 6.2 Agentic Team Development (BMAD Method)
- **Specialized AI Agents**: Analyst, Product Manager, Architect, Scrum Master, Product Owner, Developer, QA
- **Git-Based Artifact Versioning**: Complete audit trail from ideation to implementation
- **Context-Engineered Development**: Hyper-detailed development stories
- **Collaborative Review**: Human + AI review processes
...
- **Phase-Based Tool Selection**: Choose right tool for each development phase
- **Workflow Patterns**: Optimized patterns for different team sizes
- **Integration Strategies**: Combining frameworks with assistants
- **Decision Frameworks**: Systematic tool selection methodology

#### 6.5 Integration
- **Framework Comparison**: Detailed comparison of Spec Kit vs BMAD
...
<!-- section_id: "76bc7c2f-b131-4f7d-a220-4b086dddfc02" -->
...
- **Storage & CDN**: S3, Cloud Storage, Cloudinary, Cloudflare
- **Serverless**: Lambda, Cloud Functions, Edge Functions
- **Services**: Email, SMS, Payments, Analytics, Monitoring

#### 7.2 Universal Principles
- **Infrastructure as Code**: Terraform, Pulumi, CloudFormation
- **Configuration as Code**: Version all platform configs
- **Environment Parity**: Dev → Staging → Production
- **Secret Management**: Secure credential handling
- **CI/CD Integration**: Automated deployments

#### 7.3 Database Integration
- **Databases**: See `platform-version-control/databases/` subdirectory
- **Migration Tools**: Liquibase, Flyway, Supabase CLI, Firebase CLI
- **Coordination**: Database + platform deployment workflows
- **Schema Management**: Version-controlled database changes

#### 7.4 Comprehensive Coverage
- **Complete Platform Stack**: Every service your app uses
- **Universal Practices**: Applicable to all platforms
- **Platform-Specific Guides**: Detailed implementation for each
- **Best Practices**: Proven patterns and workflows

<!-- section_id: "89e4d66c-2201-46ce-b24d-8922172347ea" -->
## Usage Guidelines

<!-- section_id: "6e88475f-2871-4040-98e9-83e1fb416291" -->
### For Developers
...
<!-- section_id: "7ca00c3e-4d70-4d3e-afcf-5121087c4244" -->
### For AI Agents
...
<!-- section_id: "2a5729eb-3248-4687-93ae-7f9d28b0f848" -->
## Integration with Trickle-Down Structure

<!-- section_id: "44a29eee-5f72-4be6-98ee-15cc10f47b41" -->
### Level 0 → Level 0.75
...
<!-- section_id: "94681013-79ce-4f80-85c1-75ad86951c9e" -->
...
<!-- section_id: "cba10fb9-1f48-4a93-8957-d45694faf508" -->
### Level 0.75 → Level 2
...
<!-- section_id: "9188bf5c-418d-4f53-967a-34c96d20d803" -->
## Tool Documentation

<!-- section_id: "ffe11927-6045-4214-9dde-b3cb6cfa3d58" -->
...
<!-- section_id: "c69c7321-72d3-4977-8046-c139f9f170ae" -->
### Browser Automation
...
<!-- section_id: "8a425528-fbcf-4802-b325-6a2bb138b5c7" -->
...
<!-- section_id: "8a4e6745-f01b-411b-911c-812c40f3f86f" -->
### Project Analysis
...
<!-- section_id: "085dc990-dfd5-4909-95cc-bc7fb7af7bd5" -->
### MCP Tools
...
<!-- section_id: "641dfa0c-5289-41bf-a3d4-41d984474788" -->
### AI Development Frameworks
- [Frameworks Overview](./ai-development-frameworks/README.md)
- [Spec Kit Guide](./ai-development-frameworks/spec-kit-guide.md)
- [BMAD Method Guide](./ai-development-frameworks/bmad-method-guide.md)
- [Framework Comparison](./ai-development-frameworks/framework-comparison.md)
- [Integration Guide](./ai-development-frameworks/integration-guide.md)
- [AI Coding Assistants Guide](./ai-development-frameworks/ai-coding-assistants-guide.md)
...
<!-- section_id: "1c25755f-be66-42e6-a29d-d21b1b0f05e1" -->
...
- [Database Integration](./platform-version-control/database-integration.md)
- [Database Version Control](./platform-version-control/databases/)
  - [Database Overview](./platform-version-control/databases/README.md)
  - [Universal DB Guide](./platform-version-control/databases/universal-db-version-control-guide.md)
  - [Platform-Specific DB Guides](./platform-version-control/databases/platform-specific-guides.md)
  - [Migration Tools Comparison](./platform-version-control/databases/migration-tools-comparison.md)
...
<!-- section_id: "697fbab1-f6c0-4298-95e8-eef90d4fe092" -->
## Implementation Status

<!-- section_id: "247bccac-8ba6-4040-824b-0d05fbd0549c" -->
### ✅ Completed Tools
...
<!-- section_id: "5a07c1df-3f0e-44a1-8f6e-5b4f4de24dbe" -->
## File Structure
...
<!-- section_id: "60275f8b-e2fb-40d8-970b-a55a484b553c" -->
## Testing

<!-- section_id: "49349d86-c396-449e-afca-4050282f8fc4" -->
### Test Suite
```bash
...
<!-- section_id: "81653c06-baf6-42b6-a279-6d0b723c6858" -->
### Test Coverage
...
<!-- section_id: "8e76328a-2d22-4c68-8c14-cf45d56e3bb6" -->
## Future Enhancements

<!-- section_id: "7dbd6a68-9585-4a8b-8ec3-14b31de54700" -->
### Planned Features
...
<!-- section_id: "842482c4-f088-41ea-9f7d-bfddd9da6fd8" -->
### Extensibility
...
<!-- section_id: "272eeff1-ebe7-4d8c-8a99-4a529004205d" -->
## Documentation Standards

<!-- section_id: "e93ace85-9b96-4e90-b56f-a2f27cf6c1cb" -->
### File Naming
- Use kebab-case for directory names
- Use descriptive names that clearly indicate purpose
- Include version numbers where appropriate

<!-- section_id: "f0b185e8-086b-4185-baab-fca9db900b01" -->
### Content Structure
...
<!-- section_id: "a8fd5e93-e93f-46e7-82d1-a98c939ec95a" -->
### Code Examples
