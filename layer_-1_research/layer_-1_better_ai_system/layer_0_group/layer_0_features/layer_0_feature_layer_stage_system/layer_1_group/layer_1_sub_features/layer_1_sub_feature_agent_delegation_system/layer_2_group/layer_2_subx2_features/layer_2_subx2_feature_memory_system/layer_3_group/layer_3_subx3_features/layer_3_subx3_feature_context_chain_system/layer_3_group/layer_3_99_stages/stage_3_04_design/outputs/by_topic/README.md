...
- `stage_2_04_design/outputs/by_topic/04_source_of_truth_to_avenue_flow.md` → doc 06
- `stage_2_04_design/outputs/by_topic/01_unified_sync_architecture.md` → doc 07
