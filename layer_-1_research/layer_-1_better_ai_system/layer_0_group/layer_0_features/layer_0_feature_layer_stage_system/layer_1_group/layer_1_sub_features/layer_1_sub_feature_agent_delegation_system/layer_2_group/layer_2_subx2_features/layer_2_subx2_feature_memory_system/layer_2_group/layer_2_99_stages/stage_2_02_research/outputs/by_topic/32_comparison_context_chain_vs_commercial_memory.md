...
**Context loading follows the directory path**: when an agent enters `layer_2_subx2_feature_memory_system/`, it reads every `0AGNOSTIC.md` from root down to that entity:
...
5. `layer_2_subx2_feature_memory_system/0AGNOSTIC.md` (entity-specific identity)
