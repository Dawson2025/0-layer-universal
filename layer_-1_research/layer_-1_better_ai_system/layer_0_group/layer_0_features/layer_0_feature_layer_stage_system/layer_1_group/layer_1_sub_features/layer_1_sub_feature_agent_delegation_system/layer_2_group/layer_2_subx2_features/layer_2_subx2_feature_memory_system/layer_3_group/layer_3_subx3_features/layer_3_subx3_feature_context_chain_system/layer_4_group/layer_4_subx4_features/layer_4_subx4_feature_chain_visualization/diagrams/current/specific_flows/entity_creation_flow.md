...
└─────────────────────────────────────────────────────────────────────────────────┘
    ...
    │  • conventions.childNaming.example = "layer_2_subx2_feature_context_system" │
    ...
    │                                                                           │
    │  Result: layer_2_subx2_feature_session_recovery                             │
    └───────────────────────────────────────────────────────────────────────────┘
                    │
                    ▼
    ┌───────────────────────────────────────────────────────────────────────────┐
    ...
    │                                                                           │
    │  Creates:                                                                 │
    │  └── layer_2_subx2_feature_session_recovery/                                │
...
|---------|-------|--------|
| Wrong naming | Agent doesn't read parent's index.jsonld | Creates `subfeature_X` instead of `layer_2_subx2_feature_X` |
...
| Wrong layer number | Agent doesn't know parent's layer | Creates `layer_0_` when should be `layer_2_` |
