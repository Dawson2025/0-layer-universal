...
| Universal stage report protocol | `layer_0/.0agnostic/03_protocols/stage_report_protocol.md` |
| Stage report rule | `layer_0/.0agnostic/02_rules/static/STAGE_REPORT_RULE.md` |
| Principle 4 (Stage Reports) | `layer_0/.0agnostic/01_knowledge/principles/principles/STAGE_DELEGATION_PRINCIPLES.md` |
