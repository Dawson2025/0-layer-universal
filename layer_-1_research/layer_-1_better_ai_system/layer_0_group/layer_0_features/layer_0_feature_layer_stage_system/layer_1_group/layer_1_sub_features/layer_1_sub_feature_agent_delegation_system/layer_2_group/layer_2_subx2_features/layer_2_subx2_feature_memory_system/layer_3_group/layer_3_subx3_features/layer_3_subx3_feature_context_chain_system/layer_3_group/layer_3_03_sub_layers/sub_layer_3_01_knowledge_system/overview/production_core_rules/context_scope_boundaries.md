...
```
layer_0/
├── sub_layer_0_04_rules/       ← Applies everywhere
...
```
layer_0/sub_layer_0_04_rules/       ← Universal scope (from layer_0)
layer_1/project_a/sub_layer_2_02_knowledge/  ← Project scope (from layer_1/project_a)
```
