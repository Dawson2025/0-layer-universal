...
REPORT_PATH="$FEATURE_ROOT/layer_2_group/layer_2_subx2_features/layer_2_subx2_feature_memory_system/layer_3_group/layer_3_subx3_features/layer_3_subx3_feature_context_chain_system/layer_3_group/layer_3_99_stages/stage_3_07_testing/outputs/by_topic/avenue_web_validation_report.md"

echo "[1/4] Enforcing canonical .0agnostic class directories in stage_3_06..."
mkdir -p \
