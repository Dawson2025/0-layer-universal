...
Layer 1:
  allowed:
    - <workspace>/layer_2_project/<project-id>/**
...
Layer 2:
  allowed:
    - <workspace>/layer_3_features/<feature-id>/**
    - <workspace>/layer_2_project/<project-id>/** (read-only)
  prohibited:
    - <workspace>/layer_2_project/** (write)
    - Project configuration files

Layer 3:
  allowed:
    - <workspace>/layer_4_components/<component-id>/**
