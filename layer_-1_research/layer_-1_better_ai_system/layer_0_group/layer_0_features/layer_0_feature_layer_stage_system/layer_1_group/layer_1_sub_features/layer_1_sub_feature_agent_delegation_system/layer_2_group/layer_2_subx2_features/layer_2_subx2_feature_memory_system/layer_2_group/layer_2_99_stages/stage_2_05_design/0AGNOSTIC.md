...
- Plan work breakdown or milestones (that's stage 04)
...
- **Example prompt**: `"Work on stage_2_05_design for memory_system. Read 0AGNOSTIC.md for instructions. Task: Design the data-based avenue expansion."`
...
| Research documents (38 docs) | `../stage_2_02_research/outputs/by_topic/` | On-demand — when referencing specific research |
| Research knowledge summary | `../stage_2_02_research/.0agnostic/01_knowledge/memory_systems/docs/core_ai_memory_architecture.md` | On-demand — for distilled findings |
...
- Research summary: `../stage_2_02_research/.0agnostic/01_knowledge/memory_systems/docs/core_ai_memory_architecture.md`
