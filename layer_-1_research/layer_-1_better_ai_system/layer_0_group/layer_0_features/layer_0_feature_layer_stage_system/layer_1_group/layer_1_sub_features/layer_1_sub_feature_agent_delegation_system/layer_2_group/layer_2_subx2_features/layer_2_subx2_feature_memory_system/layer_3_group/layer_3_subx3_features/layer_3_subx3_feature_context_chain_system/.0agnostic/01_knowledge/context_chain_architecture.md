...
| Sub-feature (layer 1) | `.../layer_2_subx2_features/sub_feature/` | 3 (`../../../`) |
| Sub-sub-feature (layer 2) | `.../layer_3_subx3_features/sub_feature/` | 3 (`../../../`) |
...
- Chain visualization: `layer_4_group/.../chain_visualization/diagrams/current/context_chain/`
- Context loading: `sub_layer_3_01_knowledge_system/overview/production_context_system/HOW_CONTEXT_WORKS.md`
