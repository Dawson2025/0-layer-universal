...
|-------------|------|---------|
| System TTS | `layer_2_group/layer_2_subx2_features/layer_2_subx2_feature_system_tts/` | Orca, Piper, highlight-and-speak |
| Agentic TTS | `layer_2_group/layer_2_subx2_features/layer_2_subx2_feature_agentic_tts/` | Claude Code hooks, MCP plugin |
