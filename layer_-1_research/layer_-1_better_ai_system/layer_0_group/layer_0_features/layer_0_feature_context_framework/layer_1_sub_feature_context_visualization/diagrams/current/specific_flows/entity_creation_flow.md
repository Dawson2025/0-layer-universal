...
└─────────────────────────────────────────────────────────────────────────────────┘
    ...
    │  • conventions.childNaming.example = "layer_1_sub_feature_context_system" │
    ...
    │                                                                           │
    │  Result: layer_1_sub_feature_session_recovery                             │
    └───────────────────────────────────────────────────────────────────────────┘
                    │
                    ▼
    ┌───────────────────────────────────────────────────────────────────────────┐
    ...
    │                                                                           │
    │  Creates:                                                                 │
    │  └── layer_1_sub_feature_session_recovery/                                │
...
|---------|-------|--------|
| Wrong naming | Agent doesn't read parent's index.jsonld | Creates `subfeature_X` instead of `layer_1_sub_feature_X` |
