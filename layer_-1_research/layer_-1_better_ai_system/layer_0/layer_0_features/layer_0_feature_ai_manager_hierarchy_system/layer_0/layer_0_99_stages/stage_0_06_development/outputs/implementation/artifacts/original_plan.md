...
todos:
  ...
  - id: framework-alignment
    content: Align layer_1/layer_1_features/layer_1_feature_layer_stage_system/layer_1/layer_1_02_sub_layers docs and templates with the ideal hierarchy’s definitions of layers, stages, and the Agent OS.
    status: pending
    dependencies:
...
- For each of `layer_0`, `layer_1_project`, `layer_2_features`, and `layer_3_components`:
...
- In a central, discoverable location (e.g. `layer_0/0.01_manager_handoff_documents/0.00_to_universal/handoff_schema.md`):
...
- Implement Section 4 for Layer 0 and one pilot project (Layer 1) first.
