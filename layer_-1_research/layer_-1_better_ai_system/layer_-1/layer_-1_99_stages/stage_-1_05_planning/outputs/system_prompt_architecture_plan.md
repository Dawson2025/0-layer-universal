...
```
Location: layer_-1/layer_-1_99_stages/
...
```
Location: layer_-1/layer_-1_99_stages/CLAUDE.md
...
Steps:
1. [ ] Move any CLAUDE.md content to layer_0/CLAUDE.md
...
2. [ ] Update layer_0/CLAUDE.md with manager role
```
...
```
Location: layer_0/layer_0_03_sub_layers/
