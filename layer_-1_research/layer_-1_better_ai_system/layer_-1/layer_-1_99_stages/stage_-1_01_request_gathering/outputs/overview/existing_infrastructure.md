...
| **Universal Rules** | `code/0_layer_universal/layer_0/layer_0_03_sub_layers/sub_layer_0_04_rules/` | Synced |
| **Prompts & Skills** | `code/0_layer_universal/layer_0/layer_0_03_sub_layers/sub_layer_0_01_prompts/` | Synced |
| **Knowledge Base** | `code/0_layer_universal/layer_0/layer_0_03_sub_layers/sub_layer_0_02_knowledge/` | Synced |
...
Because `layer_0/layer_0_03_sub_layers/sub_layer_0_04_rules/` is synced:
...
### Layer Level
```
layer_0/CLAUDE.md         ← Universal layer (applies to ALL)
...
**Works**: Storing universal rules in `/code/0_layer_universal/layer_0/layer_0_03_sub_layers/sub_layer_0_04_rules/` and having them synced means:
