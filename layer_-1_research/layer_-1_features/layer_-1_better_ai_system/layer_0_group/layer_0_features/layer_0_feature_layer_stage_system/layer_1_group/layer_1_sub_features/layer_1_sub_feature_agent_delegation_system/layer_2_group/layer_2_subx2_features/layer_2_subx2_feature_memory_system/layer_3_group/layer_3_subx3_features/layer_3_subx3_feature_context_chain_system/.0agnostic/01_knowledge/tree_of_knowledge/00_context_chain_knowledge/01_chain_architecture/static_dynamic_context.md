...
| Stage 02 research | `layer_3_99_stages/stage_3_02_research/outputs/by_topic/architecture/` | Original research |
| Default view diagram | `layer_4_group/.../chain_visualization/diagrams/current/context_chain/default_view.md` | Configurable context only |
