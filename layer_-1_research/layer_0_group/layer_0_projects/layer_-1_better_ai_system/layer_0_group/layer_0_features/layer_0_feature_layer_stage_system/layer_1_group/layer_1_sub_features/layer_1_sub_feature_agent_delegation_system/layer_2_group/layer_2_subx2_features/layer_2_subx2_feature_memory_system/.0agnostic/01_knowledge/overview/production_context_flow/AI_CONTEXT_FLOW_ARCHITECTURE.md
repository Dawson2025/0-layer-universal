...
│            │                                                                │
│            ▼                                                                │
│     layer_1/layer_2_project_X/CLAUDE.md    (Project-specific)              │
│            │                                                                │
│            ▼                                                                │
│     layer_3_group/layer_3_feature_Y/CLAUDE.md   (Feature-specific)         │
│            │                                                                │
│            ▼                                                                │
│     layer_4_group/layer_4_component_Z/CLAUDE.md  (Component-specific)      │
│                                                                             │
...
│         │ inherits + adds                                                   │
│         ▼                                                                   │
│  layer_1/layer_2_project_myapp/CLAUDE.md      PROJECT LAYER                │
│  ┌─────────────────────────────────────────────────────────────────────┐   │
...
│         │ inherits + adds                                                   │
│         ▼                                                                   │
│  .../layer_3_group/layer_3_feature_auth/CLAUDE.md    FEATURE LAYER         │
│  ┌─────────────────────────────────────────────────────────────────────┐   │
...
│         │ inherits + adds                                                   │
│         ▼                                                                   │
│  .../layer_4_group/layer_4_component_jwt/CLAUDE.md   COMPONENT LAYER       │
│  ┌─────────────────────────────────────────────────────────────────────┐   │
...
│  │ Points to: .claude/, layer_4_group/layer_4_03_sub_layers/           │   │
│  └─────────────────────────────────────────────────────────────────────┘   │
│                                                                             │
└─────────────────────────────────────────────────────────────────────────────┘
```
...
│       │                                                                     │
│       ▼                                                                     │
│  layer_2_99_stages/CLAUDE.md                 (Stages root)                 │
│       │                                                                     │
│       ▼                                                                     │
