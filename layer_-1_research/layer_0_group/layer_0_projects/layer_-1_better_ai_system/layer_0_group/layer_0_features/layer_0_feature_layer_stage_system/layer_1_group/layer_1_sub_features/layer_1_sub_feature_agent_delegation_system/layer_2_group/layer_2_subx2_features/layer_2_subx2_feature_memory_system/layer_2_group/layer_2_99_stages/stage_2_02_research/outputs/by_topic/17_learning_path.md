...
### Read (our docs)
1. `../stage_2_01_request_gathering/outputs/01_problem_statement.md` — What problem we're solving
2. `../stage_2_01_request_gathering/outputs/02_current_state.md` — What we have now (gaps and strengths)
3. `../stage_2_01_request_gathering/outputs/03_requirements.md` — What the system must/should/could do
4. `../stage_2_01_request_gathering/outputs/04_constraints.md` — What limits our design
5. `../stage_2_01_request_gathering/outputs/05_use_cases.md` — Concrete scenarios to support
6. `../stage_2_01_request_gathering/outputs/06_open_questions.md` — 11 design decisions still needed
