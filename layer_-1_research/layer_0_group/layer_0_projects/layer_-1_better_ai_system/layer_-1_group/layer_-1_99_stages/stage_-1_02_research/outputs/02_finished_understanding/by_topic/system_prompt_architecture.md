...
|--------------|----------|-------------------|
| **Universal rules** | `layer_0_group/sub_layer_0_04_rules/` (canonical) + embedded in `CLAUDE.md` | YES |
...
```
layer_-1_group/                              ← LAYER manager (manages this layer)
...
Worker finds layer-wide issue
  → writes DIRECTLY to layer_-1_group/hand_off_documents/incoming/from_below/
...
|---------|----------------------|
| Layer Manager | `layer_-1_group/.claude/agents/` |
...
```bash
cd /path/to/layer_-1_group/
claude
```

**Step 2: Layer Manager reads context**
- Claude Code loads `layer_-1_group/CLAUDE.md` (+ ancestors)
...
cd layer_-1_group/ && claude

# Start as Stages Manager
cd layer_-1_group/layer_-1_99_stages/ && claude

# Start as Stage Manager (research)
cd layer_-1_group/layer_-1_99_stages/stage_-1_02_research/ && claude
```
...
```markdown
# File: layer_-1_group/hand_off_documents/incoming/from_below/20260126_escalation.md
...
│
├── layer_0_group/                          ← LAYER manager (universal layer)
...
# Write escalation directly to layer_-1_group/hand_off_documents/incoming/from_below/
...
- `layer_0_group/layer_0_00_layer_registry/README.md` - Layer entity structure definition
- `layer_0_group/layer_0_01_ai_manager_system/README.md` - Manager/worker patterns
- `layer_0_group/layer_0_02_manager_handoff_documents/README.md` - Handoff protocol
- `layer_0_group/layer_0_03_sub_layers/sub_layer_0_04_rules/` - Canonical rules location
