...
`0_layer_universal/layer_0_group/.../sub_layer_0_06_local/setup/sub_layer_0_06_03_subx2_layers/`
...
**Commands**:
```bash
cd /home/dawson/dawson-workspace/code/0_layer_universal/layer_0_group/.../setup/
