...
└── 00_seamless_ai_collaboration/        ROOT NEED
    ...
    │
    └── 06_context_flow/                 "Does context reach agents?" [NEW]
        ├── need_01_no_amnesia
        ├── need_02_context_propagation_works
        ├── need_03_static_context_available
        ├── need_04_dynamic_context_available
        ├── need_05_entry_points_right_detail
        └── need_06_navigation_to_deeper_details
```
...
| **06_context_flow** | Does context reach agents? | no_amnesia, context_propagation_works, static_context_available, dynamic_context_available, entry_points_right_detail, navigation_to_deeper_details |
