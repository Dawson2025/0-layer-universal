...
- Course and classroom management automation
- Educational workflow patterns and domain models
...
- **0AGNOSTIC.md** — Source of truth for entity context
- **.0agnostic/** — Research resources (knowledge, rules, protocols)
...
- **Sibling projects**: `../layer_-1_langtrak_dev_agent_system/`
...
2. Check `layer_-1_group/layer_-1_99_stages/` for current stage
...
| Stage | Name | Status |
|-------|------|--------|
| 01 | Request Gathering | Pending |
| 02 | Research | Pending |
| 03 | Instructions | Pending |
| 04 | Design | Pending |
| 05 | Planning | Pending |
| 06 | Development | Pending |
| 07 | Testing | Pending |
| 08 | Criticism | Pending |
| 09 | Fixing | Pending |
| 10 | Current Product | Pending |
| 11 | Archives | Pending |

---

**Created**: 2026-02-28
**Status**: Active - Infrastructure ready for research initiation
