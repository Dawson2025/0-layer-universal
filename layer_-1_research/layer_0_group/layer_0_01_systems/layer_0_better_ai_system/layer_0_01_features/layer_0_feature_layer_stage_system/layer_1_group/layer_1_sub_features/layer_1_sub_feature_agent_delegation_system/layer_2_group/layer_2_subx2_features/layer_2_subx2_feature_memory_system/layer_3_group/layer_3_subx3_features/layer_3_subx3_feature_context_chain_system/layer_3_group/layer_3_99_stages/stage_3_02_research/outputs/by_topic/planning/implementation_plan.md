...
│
├── school-context.md
│   paths: layer_1/layer_2_projects/layer_2_project_school/**
│
├── universal-layer.md
│   paths: layer_0/**
│
...
1. Find the `.gab.jsonld` for your role — read the matching `.integration.md` (same base name) for agent behavior context (Layer 4)
2. For precise mode constraints, query the `.gab.jsonld` via jq (Layer 2)
3. Read .claude/skills/*/SKILL.md — check WHEN/WHEN NOT conditions (Layer 3)
```
