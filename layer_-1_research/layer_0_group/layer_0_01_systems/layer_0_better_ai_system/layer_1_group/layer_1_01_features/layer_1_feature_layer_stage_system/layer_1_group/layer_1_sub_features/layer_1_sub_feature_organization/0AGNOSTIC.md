...
- Features (R&D) and instances (operational) have fundamentally different organizational needs
- The school system validates the pattern outside AI: knowledge graph, student modeling, career alignment
- Stage scaffolding in production templates would make the tree of needs pattern standard for all new entities
...
| Stage 01 (requests) | `layer_1_group/layer_1_99_stages/stage_1_01_request_gathering/0AGNOSTIC.md` |
| Stage 04 (design) | `layer_1_group/layer_1_99_stages/stage_1_04_design/0AGNOSTIC.md` |
...
| Work Type | Location |
|-----------|----------|
| Requirements | `layer_1_group/layer_1_99_stages/stage_1_01_request_gathering/outputs/` |
| Design decisions | `layer_1_group/layer_1_99_stages/stage_1_04_design/outputs/design_decisions/` |
| Research | `layer_1_group/layer_1_99_stages/stage_1_02_research/outputs/` |
