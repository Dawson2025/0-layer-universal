...
- **Metadata**
  ...
  - `from`: e.g., `"layer_2/auth-system/planning"` or `"layer_3/login-component/implementation"`.
  - `to`: target agent or stage, e.g., `"layer_3/login-component/implementation"`, `"layer_2/auth-system/testing"`.
...
- E.g., `layer_3_features/2.01_manager_handoff_documents/2.01_to_components/outgoing.json`
