...
<!-- section_id: "e894e743-f64c-4390-9f9e-f44306295984" -->
## Identity
...
<!-- section_id: "d94069d0-11e9-4313-8fa4-505e85aca915" -->
## Triggers
Load this context when:
- User mentions: context loading, load order, context budget, priority resolution
- Working on: Loading strategies, context optimization, budget management
- Entering: `layer_3_subx3_feature_context_loading/`

<!-- section_id: "b8536782-6ef5-4eb2-89da-379573954d69" -->
## Pointers
<!-- section_id: "e04b8922-f3fa-4835-b75b-849966506dc8" -->
### On Entry
1. Read `0INDEX.md` for current state
2. Check `layer_3_group/layer_3_99_stages/` for stage progress

<!-- section_id: "9535b2f5-67c9-4a69-9f06-3e4cbba63bdd" -->
### Navigation
| Direction | Path |
|-----------|------|
| Parent | `../../../0AGNOSTIC.md` |
...
<!-- section_id: "68ca4b6d-9f62-46e5-93bc-0482b4bc527c" -->
## Where to Contribute
| Work Type | Location |
|-----------|----------|
