...
| Stage 02 research | `layer_2_99_stages/stage_2_02_research/outputs/by_topic/integration/` | Original research on delivery mechanisms |
| Avenue test script | `layer_2_99_stages/stage_2_07_testing/outputs/test_avenue_coverage_functional.sh` | Automated validation |
