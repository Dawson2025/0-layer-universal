...
<!-- section_id: "9408c556-8f88-430c-8796-29acce5116fc" -->
## Current Purposes
...
<!-- section_id: "e7f93551-a895-4ce9-bc92-2d14f579c5b1" -->
## Compatibility
- `outputs/by_topic/` remains available for legacy links only.
- New files should not be authored directly in `outputs/by_topic/`.
