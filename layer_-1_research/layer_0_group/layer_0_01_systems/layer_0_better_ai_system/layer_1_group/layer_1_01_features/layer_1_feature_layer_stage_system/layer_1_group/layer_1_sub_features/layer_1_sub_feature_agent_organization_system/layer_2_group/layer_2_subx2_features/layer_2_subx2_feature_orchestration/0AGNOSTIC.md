...
<!-- section_id: "43925009-cdc4-4bec-a2bc-963b41f4f109" -->
## Identity
...
<!-- section_id: "6a06a523-8585-4297-8d46-11d127337a16" -->
## Triggers
Load this context when:
- User mentions: orchestration, agent spawning, inter-agent communication, coordination
- Working on: Orchestration design, coordination protocols, agent lifecycle management
- Entering: `layer_2_subx3_feature_orchestration/`

<!-- section_id: "d757aac8-ab91-4a6e-8826-b1937068591d" -->
## Pointers
<!-- section_id: "c7b9a275-5312-4a01-aa76-df264ef34a17" -->
### On Entry
1. Read `0INDEX.md` for current state
2. Check `layer_3_group/layer_3_subx3_features/` for sub-features

<!-- section_id: "61c95936-8b50-4891-b092-d5741e4b76cc" -->
### Navigation
| Direction | Path |
|-----------|------|
| Parent | `../../../0AGNOSTIC.md` |
...
<!-- section_id: "e1f24c01-49a4-4080-aa53-a1bf1b80701a" -->
## Where to Contribute
| Work Type | Location |
|-----------|----------|
