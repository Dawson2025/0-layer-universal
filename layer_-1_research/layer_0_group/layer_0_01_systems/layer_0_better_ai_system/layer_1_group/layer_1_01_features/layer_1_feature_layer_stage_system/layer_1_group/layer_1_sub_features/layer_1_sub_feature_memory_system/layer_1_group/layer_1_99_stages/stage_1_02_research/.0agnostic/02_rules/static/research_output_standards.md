...
3. **Numbered content sections** (H2) with subsections (H3+)
...
- Include code examples for implementation details
- Include ASCII diagrams for hierarchies and flows
- Brain analogies where applicable for biological memory mappings
