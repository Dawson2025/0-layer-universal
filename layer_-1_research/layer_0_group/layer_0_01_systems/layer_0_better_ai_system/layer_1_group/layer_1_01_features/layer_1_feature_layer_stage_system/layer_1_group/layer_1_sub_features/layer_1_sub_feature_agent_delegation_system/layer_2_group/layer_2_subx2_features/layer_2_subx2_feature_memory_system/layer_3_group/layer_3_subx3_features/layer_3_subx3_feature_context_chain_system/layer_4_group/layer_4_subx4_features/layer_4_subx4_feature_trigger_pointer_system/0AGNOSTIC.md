# 0AGNOSTIC.md - layer_4_subx4_feature_trigger_pointer_system

## Identity
You are an agent at **Layer 4** (Sub-Feature), **Sub-Feature**: Trigger Pointer System.
...
- Entering: `layer_4_subx4_feature_trigger_pointer_system/`
...
| Work Type | Location |
|-----------|----------|
| Requirements | `layer_4_group/layer_4_99_stages/stage_4_01_request_gathering/outputs/` |
| Research | `layer_4_group/layer_4_99_stages/stage_4_02_research/outputs/` |
| Design | `layer_4_group/layer_4_99_stages/stage_4_04_design/outputs/` |
| Implementation | `layer_4_group/layer_4_99_stages/stage_4_06_development/outputs/` |
