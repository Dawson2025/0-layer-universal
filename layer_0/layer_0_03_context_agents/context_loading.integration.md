...
- When validating entity context, verify entity has canonical structure per .0agnostic/06_context_avenue_web/01_file_based/04_@import_references/entity_structure.md (0AGNOSTIC.md, .0agnostic/, .1merge/, layer_N_group/, synthesis/)
