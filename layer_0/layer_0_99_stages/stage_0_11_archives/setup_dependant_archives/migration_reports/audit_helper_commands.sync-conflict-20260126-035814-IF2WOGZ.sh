#!/bin/bash
# resource_id: "33782ca7-8a1e-41bb-b4f8-e490b5876db1"
# resource_type: "script"
# resource_name: "audit_helper_commands.sync-conflict-20260126-035814-IF2WOGZ"
...
echo "   find 0.01_universal_setup_file_tree_0 -path '*0.06_mcp_servers_and_apis_and_secrets/_shared/*' -type f | wc -l"
echo ""
...
echo "   find 0.01_universal_setup_file_tree_0 -path '*0.06_mcp_servers_and_apis_and_secrets/*' -type f"
echo ""
