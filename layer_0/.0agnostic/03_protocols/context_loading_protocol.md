...
- Current sub_layer: if nested (e.g., sub_layer_0_02_rules)
...
- `sub_layer_0_02_rules/` must be loaded for any work
...
```markdown
@override layer_0/sub_layer_0_02_rules/git_commit_rule.md
...
- **Priority Rules**: `sub_layer_0_02_rules/context_priority_rules.md`
- **Scope Boundaries**: `sub_layer_0_02_rules/context_scope_boundaries.md`
