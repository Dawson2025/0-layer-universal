...
| 02 | context_agents | **CONTEXT LOADING AGENT** - AALang agent for context loading (4-mode-13-actor pattern) |
| 03 | knowledge_system | Domain knowledge, reference materials |
| 04 | principles | Guiding principles for decisions |
| 05 | rules | Universal rules (modification protocol, commit rule, etc.) |
| 06 | protocols | Session init protocols, context protocols |
| 07+ | setup_dependant_hierarchy | OS/tool specific configuration |
