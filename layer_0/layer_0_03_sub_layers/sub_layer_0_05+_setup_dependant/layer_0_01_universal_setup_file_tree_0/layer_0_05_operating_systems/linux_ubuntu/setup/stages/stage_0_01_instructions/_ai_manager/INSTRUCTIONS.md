...
2. Read `../../stage_0.00_request_gathering/output/REQUEST_*.md`
...
- [ ] HANDOFF.md updated
- [ ] Ready for stage_0.02

## Hand Off
When complete, update `../HANDOFF.md` status to COMPLETE and note that stage_0.02 is ready.
