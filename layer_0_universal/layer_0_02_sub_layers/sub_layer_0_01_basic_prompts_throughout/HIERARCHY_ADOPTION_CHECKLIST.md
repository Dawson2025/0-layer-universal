...
- [ ] **Read MASTER_DOCUMENTATION_INDEX.md**
  - Location: `/home/dawson/code/0_layer_ai_context/0_context/MASTER_DOCUMENTATION_INDEX.md`
  - Focus: "AI Manager Hierarchy System" section (lines 77-101)
  - Goal: Understand what the hierarchy is and where docs live

- [ ] **Read SYSTEM_OVERVIEW.md**
  - Location: `/home/dawson/code/0_layer_ai_context/0_context/SYSTEM_OVERVIEW.md`
...
- [ ] **Read USAGE_GUIDE.md**
  - Location: `/home/dawson/code/0_layer_ai_context/0_context/USAGE_GUIDE.md`
...
- [ ] **Read Layer/Stage Framework README**
  - Location: `/home/dawson/code/0_layer_ai_context/0_context/0.01_layer_stage_framework/README.md`
...
- [ ] **Read Layer 0 Manager System README**
  - Location: `/home/dawson/code/0_layer_ai_context/0_context/layer_0_universal/0.00_ai_manager_system/README.md`
  - Goal: Understand universal manager/worker patterns

- [ ] **Read Layer 1 Manager System README** (if you're working at L1)
  - Location: `/home/dawson/code/0_layer_ai_context/0_context/layer_1_project/1.00_ai_manager_system/README.md`
  - Goal: Understand project-level manager/worker patterns

- [ ] **Read Layer 2 Manager System README** (if you're working at L2)
  - Location: `/home/dawson/code/0_layer_ai_context/0_context/layer_2_features/2.00_ai_manager_system/README.md`
  - Goal: Understand feature-level manager/worker patterns

- [ ] **Read Layer 3 Manager System README** (if you're working at L3)
  - Location: `/home/dawson/code/0_layer_ai_context/0_context/layer_3_components/3.00_ai_manager_system/README.md`
...
- [ ] **Read Handoff Schema Definition**
  - Location: `/home/dawson/code/0_layer_ai_context/0_context/layer_0_universal/0.01_manager_handoff_documents/0.00_to_universal/handoff_schema.md`
...
- [ ] **Locate OS-specific context for your layer**
  - L0: `/home/dawson/code/0_layer_ai_context/0_context/layer_0_universal/0.99_stages/stage_0.01_instructions/ai_agent_system/os/<os-id>/`
  - L1: `/home/dawson/code/0_layer_ai_context/0_context/layer_1_project/1.99_stages/stage_1.01_instructions/ai_agent_system/os/<os-id>/`
  - L2: `/home/dawson/code/0_layer_ai_context/0_context/layer_2_features/2.99_stages/stage_2.01_instructions/ai_agent_system/os/<os-id>/`
  - L3: `/home/dawson/code/0_layer_ai_context/0_context/layer_3_components/3.99_stages/stage_3.01_instructions/ai_agent_system/os/<os-id>/`
...
- [ ] **Read Observability Protocol**
  - Location: `/home/dawson/code/0_layer_ai_context/0_context/layer_0_universal/0.02_sub_layers/sub_layer_0.13_universal_protocols/observability/README.md`
...
- [ ] **Read Safety and Governance Rules**
  - Location: `/home/dawson/code/0_layer_ai_context/0_context/layer_0_universal/0.02_sub_layers/sub_layer_0.04_universal_rules/safety_governance.md`
...
- [ ] **Read Deployment Guide**
  - Location: `/home/dawson/code/0_layer_ai_context/0_context/layer_0_universal/0.02_sub_layers/sub_layer_0.05_os_setup/trickle_down_0.5_setup/0_instruction_docs/deployment/AI_MANAGER_HIERARCHY_DEPLOYMENT.md`
...
- [ ] **Create first handoff document** (from L0 to L1, or L1 to L2)
  - Use handoff schema: `/home/dawson/code/0_layer_ai_context/0_context/layer_0_universal/0.01_manager_handoff_documents/0.00_to_universal/handoff_schema.md`
...
**Top-Level Docs**:
- MASTER_DOCUMENTATION_INDEX.md: `/home/dawson/code/0_layer_ai_context/0_context/MASTER_DOCUMENTATION_INDEX.md`
- SYSTEM_OVERVIEW.md: `/home/dawson/code/0_layer_ai_context/0_context/SYSTEM_OVERVIEW.md`
- USAGE_GUIDE.md: `/home/dawson/code/0_layer_ai_context/0_context/USAGE_GUIDE.md`
...
**Orchestration Docs**:
- Framework Orchestration: `/home/dawson/code/0_layer_ai_context/0_context/layer_0_universal/0.02_sub_layers/sub_layer_0.13_universal_protocols/framework_orchestration/0_instruction_docs/framework_orchestration_overview.md`
- CLI Recursion: `/home/dawson/code/0_layer_ai_context/0_context/layer_0_universal/0.02_sub_layers/sub_layer_0.13_universal_protocols/cli_recursion/0_instruction_docs/cli_recursion_syntax.md`

**Rollout Plan**:
- Rollout Plan: `/home/dawson/.cursor/plans/ai_manager_hierarchy_rollout_plan.md`
- Migration Guide: `/home/dawson/code/0_layer_ai_context/0_context/layer_0_universal/0.02_sub_layers/sub_layer_0.01_basic_prompts_throughout/MIGRATION_GUIDE.md` (to be created)
