...
│
├── .0agnostic/06_context_avenue_web/file_based/01_aalang/  # AALang agent files live here
...
│   │   ├── file_based/                    # Deterministic, zero-dependency avenues
...
│   │   └── data_based/                    # Derived indexes, queryable, optional
...
├── GEMINI.md                              # Auto-generated by agnostic-sync.sh
├── OPENAI.md                              # Auto-generated by agnostic-sync.sh
├── .0agnostic/06_context_avenue_web/file_based/01_aalang/  # Stage AALang agent files
...
│   ├── 05_handoff_documents/{01_incoming/{01_from_above,02_from_below},02_outgoing/{01_to_above,02_to_below}}/
│   ├── 06_context_avenue_web/{00_context_avenue_web_registry,file_based/{01_aalang,02_aalang_markdown_integration,03_auto_memory,04_@import_references,05_skills,06_agents,07_path_specific_rules,08_hooks},data_based/{09_knowledge_graph,10_relational_index,11_vector_embeddings,12_temporal_index,13_shimi_structures}}/
│   └── 07+_setup_dependant/
...
AALang agent files live inside `.0agnostic/06_context_avenue_web/file_based/01_aalang/` at each level (entity root, stages).
...
| **AALang location** | Always in context avenue web | `.0agnostic/06_context_avenue_web/file_based/01_aalang/` |
...
| `layer_N.orchestrator.gab.jsonld` | `.0agnostic/06_context_avenue_web/file_based/01_aalang/` | Entity orchestrator | Copy from sibling, adapt |
| `{purpose}.gab.jsonld` | `.0agnostic/06_context_avenue_web/file_based/01_aalang/` | Full GAB agent | Create per entity |
| `{purpose}.agent.jsonld` | `.0agnostic/06_context_avenue_web/file_based/01_aalang/` | Lightweight stub | Create per entity |
| `layer_N_99_stages.orchestrator.gab.jsonld` | `layer_N_99_stages/` | Stages orchestrator | Create or copy from sibling |
| `stage_XX.orchestrator.gab.jsonld` | Each stage's `.0agnostic/06_context_avenue_web/file_based/01_aalang/` | Stage orchestrator | Create per stage |
...
- Context avenues live in `.0agnostic/06_context_avenue_web/` with two subdirs: `file_based/` (01-08) and `data_based/` (09-13)
