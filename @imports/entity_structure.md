...
|---|---|---|
| `layer_N_orchestrator.gab.jsonld` | `layer_N_orchestrator.integration.md` | `.0agnostic/01_knowledge/layer_stage_system/resources/tools/jsonld-to-md.sh` |
| `layer_N_99_stages_orchestrator.gab.jsonld` | `layer_N_99_stages_orchestrator.integration.md` | `.0agnostic/01_knowledge/layer_stage_system/resources/tools/jsonld-to-md.sh` |
| `stage_N_XX_name_agent.jsonld` | `stage_N_XX_name_agent.integration.md` | `.0agnostic/01_knowledge/layer_stage_system/resources/tools/jsonld-to-md.sh` |

**Generate**: `bash .0agnostic/01_knowledge/layer_stage_system/resources/tools/jsonld-to-md.sh <path-to-jsonld>` then rename `*.jsonld.integration.md` → `*.integration.md`
