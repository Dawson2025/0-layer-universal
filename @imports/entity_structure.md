...
│
├── .0agnostic/06_context_avenue_web/01_aalang/  # AALang agent files live here
...
│   │   ├── 00_context_avenue_web_registry/  # Management hub (registry.json, manage-avenues.sh)
...
├── GEMINI.md                              # Auto-generated by agnostic-sync.sh
├── OPENAI.md                              # Auto-generated by agnostic-sync.sh
├── .0agnostic/06_context_avenue_web/01_aalang/  # Stage AALang agent files
...
│   ├── 06_context_avenue_web/{00_registry,01_aalang,02_aalang_markdown_integration,03_auto_memory,04_@import_references,05_skills,06_agents,07_path_specific_rules,08_hooks}/
│   └── 07+_setup_dependant/
...
AALang agent files live inside `.0agnostic/06_context_avenue_web/01_aalang/` at each level (entity root, stages).
...
| **AALang location** | Always in context avenue web | `.0agnostic/06_context_avenue_web/01_aalang/` |
...
| `layer_N.orchestrator.gab.jsonld` | `.0agnostic/06_context_avenue_web/01_aalang/` | Entity orchestrator | Copy from sibling, adapt |
| `{purpose}.gab.jsonld` | `.0agnostic/06_context_avenue_web/01_aalang/` | Full GAB agent | Create per entity |
| `{purpose}.agent.jsonld` | `.0agnostic/06_context_avenue_web/01_aalang/` | Lightweight stub | Create per entity |
| `layer_N_99_stages.orchestrator.gab.jsonld` | `layer_N_99_stages/` | Stages orchestrator | Create or copy from sibling |
| `stage_XX.orchestrator.gab.jsonld` | Each stage's `.0agnostic/06_context_avenue_web/01_aalang/` | Stage orchestrator | Create per stage |
...
- Context avenues (aalang, skills, agents, hooks, etc.) live in `.0agnostic/06_context_avenue_web/`
